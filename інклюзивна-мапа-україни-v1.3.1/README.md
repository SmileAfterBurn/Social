...
Проект тепер включає спеціалізований розділ **"Захист дітей"** для забезпечення безпеки та благополуччя дітей:

### Можливості модуля захисту дітей:

- 📞 **Національні гарячі лінії** — цілодобовий доступ до 4 спеціалізованих служб:
  - 116 111 — Національна дитяча гаряча лінія
  - 0 800 501 720 — Гаряча лінія Уповноваженого Президента
  - 0 800 500 335 — Ла Страда-Україна
  - 102 — Ювенальна поліція

- 🏢 **6 центрів захисту дітей** у великих містах України:
  - Київ, Львів, Одеса, Дніпро, Харків, Запоріжжя
  
- 🚨 **Екстрена допомога** — швидкий доступ до екстрених контактів
  
- 🔍 **Спеціальний фільтр** — пошук організацій категорії "Захист дітей"

- ℹ️ **Детальна інформація** — години роботи, контакти, послуги кожного центру

---

## ♿ Доступність та інклюзивність

Додаток розроблений з урахуванням потреб усіх користувачів:

### Функції доступності:

- 🔤 **Налаштування розміру тексту** — 3 рівні (звичайний, великий, дуже великий)

- 🎨 **Режим високої контрастності** — покращена читабельність для людей з вадами зору

- 🔊 **ARIA-мітки** — повна підтримка програм екранного читання

- ⌨️ **Клавіатурна навігація** — керування за допомогою клавіатури

- 💾 **Збереження налаштувань** — персональні налаштування зберігаються локально

### Як користуватися функціями доступності:

1. Натисніть на іконку **ока (👁️)** у верхньому меню
2. Виберіть потрібний розмір тексту
3. Увімкніть високу контрастність за потреби
