...
export const REMOTE_SUPPORT_ACTORS: RemoteSupportActor[] = [
  ...
  {
    id: 'r_child_1',
    name: 'Національна гаряча лінія з протидії торгівлі людьми',
    category: 'Захист дітей',
    phones: ['116 111', '0 800 500 225'],
    description: 'Цілодобова лінія для дітей у складних життєвих обставинах, жертв насильства та торгівлі людьми. Безкоштовно, конфіденційно.',
    website: 'https://www.childhotline.ua'
  },
  {
    id: 'r_child_2',
    name: 'Гаряча лінія Уповноваженого Президента з прав дитини',
    category: 'Захист дітей',
    phones: ['0 800 501 720'],
    description: 'Консультації з питань захисту прав дітей, допомога в кризових ситуаціях.',
    website: 'https://www.ombudsman.gov.ua'
  },
  {
    id: 'r_child_3',
    name: 'Ла Страда-Україна (протидія торгівлі людьми)',
    category: 'Захист дітей',
    phones: ['0 800 500 335', '+380 44 205 36 05'],
    description: 'Допомога особам, які постраждали від торгівлі людьми, експлуатації, домашнього насильства. Консультації юристів та психологів.',
    website: 'https://la-strada.org.ua'
  },
  {
    id: 'r_child_4',
    name: 'Поліція превентивної діяльності (ювенальна поліція)',
    category: 'Захист дітей',
    phones: ['102'],
    description: 'Звернення з питань протидії домашньому насильству, захисту дітей від насильства та експлуатації.'
  }
];